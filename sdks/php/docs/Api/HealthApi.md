...
```php
getAccountHealth($accept_language, $x_dona_integration): \Dona\Api\Model\HealthSummary
```
...
try {
    $result = $apiInstance->getAccountHealth($accept_language, $x_dona_integration);
    print_r($result);
} catch (Exception $e) {
...
```php
getAccountMetric($metric_id, $accept_language, $x_dona_integration): \Dona\Api\Model\MetricDetail
```
...
try {
    $result = $apiInstance->getAccountMetric($metric_id, $accept_language, $x_dona_integration);
    print_r($result);
} catch (Exception $e) {
...
```php
getAccountVerification($accept_language, $x_dona_integration): \Dona\Api\Model\Verification
```
...
try {
    $result = $apiInstance->getAccountVerification($accept_language, $x_dona_integration);
    print_r($result);
} catch (Exception $e) {
