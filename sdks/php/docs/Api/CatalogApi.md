...
```php
batchProducts($idempotency_key, $batch_request, $dona_dry_run, $dry_run, $accept_language, $dona_seller, $x_dona_integration): \Dona\Api\Model\JobAccepted
```
...
try {
    $result = $apiInstance->batchProducts($idempotency_key, $batch_request, $dona_dry_run, $dry_run, $accept_language, $dona_seller, $x_dona_integration);
    print_r($result);
} catch (Exception $e) {
...
```php
createMediaUploadUrl($media_upload_request, $accept_language, $dona_seller, $x_dona_integration): \Dona\Api\Model\MediaUploadUrl
```
...
try {
    $result = $apiInstance->createMediaUploadUrl($media_upload_request, $accept_language, $dona_seller, $x_dona_integration);
    print_r($result);
} catch (Exception $e) {
...
```php
createProduct($idempotency_key, $product_create, $dona_dry_run, $dry_run, $accept_language, $dona_seller, $x_dona_integration): \Dona\Api\Model\ProductCreated
```
...
try {
    $result = $apiInstance->createProduct($idempotency_key, $product_create, $dona_dry_run, $dry_run, $accept_language, $dona_seller, $x_dona_integration);
    print_r($result);
} catch (Exception $e) {
...
```php
delistProduct($id, $idempotency_key, $dona_dry_run, $dry_run, $accept_language, $dona_seller, $x_dona_integration): \Dona\Api\Model\ProductState
```
...
try {
    $result = $apiInstance->delistProduct($id, $idempotency_key, $dona_dry_run, $dry_run, $accept_language, $dona_seller, $x_dona_integration);
    print_r($result);
} catch (Exception $e) {
...
```php
getProduct($id, $accept_language, $dona_seller, $x_dona_integration): \Dona\Api\Model\Product
```
...
try {
    $result = $apiInstance->getProduct($id, $accept_language, $dona_seller, $x_dona_integration);
    print_r($result);
} catch (Exception $e) {
...
```php
getProductIssues($id, $accept_language, $dona_seller, $x_dona_integration): \Dona\Api\Model\ProductIssues
```
...
try {
    $result = $apiInstance->getProductIssues($id, $accept_language, $dona_seller, $x_dona_integration);
    print_r($result);
} catch (Exception $e) {
...
```php
listDeletedProducts($since, $cursor, $limit, $accept_language, $dona_seller, $x_dona_integration): \Dona\Api\Model\TombstonePage
```
...
try {
    $result = $apiInstance->listDeletedProducts($since, $cursor, $limit, $accept_language, $dona_seller, $x_dona_integration);
    print_r($result);
} catch (Exception $e) {
...
```php
listProducts($cursor, $limit, $updated_since, $status, $seller_sku, $barcode, $external_id, $q, $if_none_match, $accept_language, $dona_seller, $x_dona_integration): \Dona\Api\Model\ProductPage
```
...
try {
    $result = $apiInstance->listProducts($cursor, $limit, $updated_since, $status, $seller_sku, $barcode, $external_id, $q, $if_none_match, $accept_language, $dona_seller, $x_dona_integration);
    print_r($result);
} catch (Exception $e) {
...
```php
publishProduct($id, $idempotency_key, $dona_dry_run, $dry_run, $accept_language, $dona_seller, $x_dona_integration): \Dona\Api\Model\ProductState
```
...
try {
    $result = $apiInstance->publishProduct($id, $idempotency_key, $dona_dry_run, $dry_run, $accept_language, $dona_seller, $x_dona_integration);
    print_r($result);
} catch (Exception $e) {
...
```php
updateProduct($id, $idempotency_key, $product_update, $dona_dry_run, $dry_run, $accept_language, $dona_seller, $x_dona_integration): \Dona\Api\Model\Product
```
...
try {
    $result = $apiInstance->updateProduct($id, $idempotency_key, $product_update, $dona_dry_run, $dry_run, $accept_language, $dona_seller, $x_dona_integration);
    print_r($result);
} catch (Exception $e) {
