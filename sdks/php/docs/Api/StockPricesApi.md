...
```php
listStock($cursor, $page, $limit, $updated_since, $seller_sku, $if_none_match, $accept_language, $x_dona_integration): \Dona\Api\Model\StockLineViewPage
```
...
try {
    $result = $apiInstance->listStock($cursor, $page, $limit, $updated_since, $seller_sku, $if_none_match, $accept_language, $x_dona_integration);
    print_r($result);
} catch (Exception $e) {
...
```php
setPrices($idempotency_key, $price_request, $atomic, $dona_dry_run, $dry_run, $accept_language, $x_dona_integration): \Dona\Api\Model\BulkResult
```
...
try {
    $result = $apiInstance->setPrices($idempotency_key, $price_request, $atomic, $dona_dry_run, $dry_run, $accept_language, $x_dona_integration);
    print_r($result);
} catch (Exception $e) {
...
```php
setStock($idempotency_key, $stock_request, $atomic, $dona_dry_run, $dry_run, $accept_language, $x_dona_integration): \Dona\Api\Model\BulkResult
```
...
try {
    $result = $apiInstance->setStock($idempotency_key, $stock_request, $atomic, $dona_dry_run, $dry_run, $accept_language, $x_dona_integration);
    print_r($result);
} catch (Exception $e) {
