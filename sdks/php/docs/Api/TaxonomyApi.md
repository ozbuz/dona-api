...
```php
getCategoryRequirements($id, $accept_language, $dona_seller, $x_dona_integration): \Dona\Api\Model\CategoryRequirements
```
...
try {
    $result = $apiInstance->getCategoryRequirements($id, $accept_language, $dona_seller, $x_dona_integration);
    print_r($result);
} catch (Exception $e) {
...
```php
listCategories($parent_id, $cursor, $limit, $accept_language, $dona_seller, $x_dona_integration): \Dona\Api\Model\CategoryPage
```
...
try {
    $result = $apiInstance->listCategories($parent_id, $cursor, $limit, $accept_language, $dona_seller, $x_dona_integration);
    print_r($result);
} catch (Exception $e) {
...
```php
searchBrands($q, $cursor, $limit, $accept_language, $dona_seller, $x_dona_integration): \Dona\Api\Model\BrandPage
```
...
try {
    $result = $apiInstance->searchBrands($q, $cursor, $limit, $accept_language, $dona_seller, $x_dona_integration);
    print_r($result);
} catch (Exception $e) {
...
```php
searchIkpu($q, $cursor, $limit, $accept_language, $dona_seller, $x_dona_integration): \Dona\Api\Model\IkpuPage
```
...
try {
    $result = $apiInstance->searchIkpu($q, $cursor, $limit, $accept_language, $dona_seller, $x_dona_integration);
    print_r($result);
} catch (Exception $e) {
