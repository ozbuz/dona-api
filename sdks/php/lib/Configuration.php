...
class Configuration
{
     ...
     * @var string
     */
    protected $booleanFormatForQueryString = self::BOOLEAN_FORMAT_STRING; // Dona: query booleans are true/false (generators/php/generate.sh)
     ...
     * @var string
     */
    protected $host = 'https://api.dona.im/seller-api/v1';
    ...
    {
        $report  = 'PHP SDK (Dona\Api) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: v1 (frozen 2026-09-24)' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://api.dona.im/seller-api/v1",
                "description" => "Production (the only environment; `dry_run` is the rehearsal).",
            ]
        ];
    }
