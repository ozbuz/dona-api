...
/**
 * OrderLineCancelledEventData Class Doc Comment
 *
 * @category Class
 * @package  Dona\Api
 * @author   OpenAPI Generator team
 ...
 */
class OrderLineCancelledEventData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'OrderLineCancelledEventData';
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling OrderLineCancelledEventData., must be bigger than or equal to 1.');
        }
     ...
     * Sets reason_code
     *
     * @param string|null $reason_code A code from the order vocabularies, or null — the buyer's free text is never pushed.
     *
     * @return self
     */
