...
/**
 * MediaUploadUrl Class Doc Comment
 *
 * @category Class
 * @package  Dona\Api
 * @author   OpenAPI Generator team
 ...
 */
class MediaUploadUrl implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'MediaUploadUrl';
     ...
     * Sets upload_url
     *
     * @param string $upload_url Presigned PUT — send the exact bytes, no Authorization header.
     *
     * @return self
     */
     ...
     * Sets public_url
     *
     * @param string $public_url Use this in `image_urls`.
     *
     * @return self
     */
