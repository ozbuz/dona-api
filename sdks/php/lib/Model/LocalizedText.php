...
/**
 * LocalizedText Class Doc Comment
 *
 * @category Class
 ...
 */
class LocalizedText implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'LocalizedText';
    ...
    {
        if (is_null($uz)) {
            throw new \InvalidArgumentException('non-nullable uz cannot be null');
        }
