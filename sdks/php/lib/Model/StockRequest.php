 ...
 */
class StockRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'items' => '\Dona\Api\Model\StockLine[]'
    ];
     ...
     * Gets items
     *
     * @return \Dona\Api\Model\StockLine[]
     */
     ...
     * Sets items
     *
     * @param \Dona\Api\Model\StockLine[] $items items
     *
     * @return self
     */
    public function setItems($items)
    {
        ...
        if ((count($items) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $items when calling StockRequest., number of items must be less than or equal to 1000.');
        }
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items when calling StockRequest., number of items must be greater than or equal to 1.');
        }
