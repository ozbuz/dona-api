 ...
 */
class ProductHold implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Product_hold';
     ...
     * Sets reason
     *
     * @param string $reason `shop_not_activated` — a pending shop's publish waits in `product_shop_holds`.
     *
     * @return self
     */
