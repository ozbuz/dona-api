 ...
 */
class StockLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'StockLine';
     ...
     * Sets quantity
     *
     * @param int $quantity ABSOLUTE stock (not a delta).
     *
     * @return self
     */
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling StockLine., must be bigger than or equal to 0.');
        }
     ...
     * Sets version
     *
     * @param string|null $version Optional; stale ⇒ line `error: version_conflict`.
     *
     * @return self
     */
     ...
     * Sets warehouse
     *
     * @param string|null $warehouse Reserved — one stock location per shop. Any value ⇒ the whole request `422 warehouse_unsupported`.
     *
     * @return self
     */
