...
/**
 * AttentionItemSubject Class Doc Comment
 *
 * @category Class
 * @package  Dona\Api
 * @author   OpenAPI Generator team
 ...
 */
class AttentionItemSubject implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AttentionItem_subject';
     ...
     * Sets type
     *
     * @param string $type Known values (open set — tolerate new ones): `product`, `order`, `return`, `key`, `webhook`, `held_write`, `incident`, `punishment`, `shop`.
     *
     * @return self
     */
