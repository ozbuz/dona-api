 ...
 */
class MeApiAccess implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Me_api_access';
     ...
     * Sets state
     *
     * @param string $state Known values (open set — tolerate new ones): `enabled`, `blocked`.
     *
     * @return self
     */
