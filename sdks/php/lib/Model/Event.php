...
class Event implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets data
     *
     * @param array<string,mixed> $data Thin payload per `type` (ids + new state, never PII) — see the top-level `webhooks` for each shape.
     *
     * @return self
     */
