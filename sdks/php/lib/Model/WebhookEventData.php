...
class WebhookEventData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'WebhookEventData';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['last_status'] === null && !$this->isNullableSetToNull('last_status')) {
            $invalidProperties[] = "'last_status' is required";
        }
     ...
     * Sets last_status
     *
     * @param int|null $last_status last_status
     *
     * @return self
     */
    public function setLastStatus($last_status)
    {
        if (is_null($last_status)) {
            array_push($this->openAPINullablesSetToNull, 'last_status');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('last_status', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
