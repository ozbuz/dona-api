...
/**
 * MetricDetailAllOfHistory Class Doc Comment
 *
 * @category Class
 * @package  Dona\Api
 * @author   OpenAPI Generator team
 ...
 */
class MetricDetailAllOfHistory implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'MetricDetail_allOf_history';
    ...
    {
        $this->setIfExists('week_start', $data ?? [], null);
    ...
    {
        if (is_null($week_start)) {
            throw new \InvalidArgumentException('non-nullable week_start cannot be null');
        }
