...
/**
 * ProductCreated Class Doc Comment
 *
 * @category Class
 * @package  Dona\Api
 * @author   OpenAPI Generator team
 ...
 */
class ProductCreated implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ProductCreated';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'status' => 'string',
        'hold' => '\Dona\Api\Model\ProductCreatedHold',
        'issues' => '\Dona\Api\Model\Issue[]',
        'created_via' => 'string'
    ];
     ...
     * @return string[]
     */
    public function getCreatedViaAllowableValues()
    {
        return [
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getCreatedViaAllowableValues();
        if (!is_null($this->container['created_via']) && !in_array($this->container['created_via'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'created_via', must be one of '%s'",
                $this->container['created_via'],
     ...
     * Gets hold
     *
     * @return \Dona\Api\Model\ProductCreatedHold|null
     */
     ...
     * Sets hold
     *
     * @param \Dona\Api\Model\ProductCreatedHold|null $hold hold
     *
     * @return self
     */
     ...
     * Sets issues
     *
     * @param \Dona\Api\Model\Issue[] $issues issues
     *
     * @return self
     */
     ...
     * Sets created_via
     *
     * @param string $created_via created_via
     *
     * @return self
     */
    public function setCreatedVia($created_via)
    {
        ...
        $allowedValues = $this->getCreatedViaAllowableValues();
        if (!in_array($created_via, $allowedValues, true)) {
