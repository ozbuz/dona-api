 ...
 */
class Tombstone implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Tombstone';
     ...
     * Sets deleted_at
     *
     * @param \DateTime $deleted_at ISO 8601 with offset (Tashkent `+05:00` on output).
     *
     * @return self
     */
