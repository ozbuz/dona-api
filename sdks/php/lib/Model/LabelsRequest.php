...
/**
 * LabelsRequest Class Doc Comment
 *
 * @category Class
 * @package  Dona\Api
 * @author   OpenAPI Generator team
 ...
 */
class LabelsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'LabelsRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['order_ids']) > 100)) {
            $invalidProperties[] = "invalid value for 'order_ids', number of items must be less than or equal to 100.";
        }
    ...
    public function setOrderIds($order_ids)
    {
        ...
        if ((count($order_ids) > 100)) {
            throw new \InvalidArgumentException('invalid value for $order_ids when calling LabelsRequest., number of items must be less than or equal to 100.');
        }
        if ((count($order_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $order_ids when calling LabelsRequest., number of items must be greater than or equal to 1.');
        }
