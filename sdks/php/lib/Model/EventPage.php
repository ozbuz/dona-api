...
class EventPage implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets items
     *
     * @param \Dona\Api\Model\Event[] $items items
     *
     * @return self
     */
     ...
     * Sets next_cursor
     *
     * @param string|null $next_cursor The id of the LAST event returned (or your own cursor echoed when `items` is empty). Store it after your batch commits; never null once you have seen an event.
     *
     * @return self
     */
     ...
     * Sets has_more
     *
     * @param bool $has_more True ⇒ call again immediately.
     *
     * @return self
     */
