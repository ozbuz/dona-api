...
class BatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'items' => '\Dona\Api\Model\BatchCommand[]'
    ];
     ...
     * Gets items
     *
     * @return \Dona\Api\Model\BatchCommand[]
     */
     ...
     * Sets items
     *
     * @param \Dona\Api\Model\BatchCommand[] $items items
     *
     * @return self
     */
    public function setItems($items)
    {
        ...
        if ((count($items) > 100)) {
            throw new \InvalidArgumentException('invalid value for $items when calling BatchRequest., number of items must be less than or equal to 100.');
        }
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items when calling BatchRequest., number of items must be greater than or equal to 1.');
        }
