...
class Brand implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['protection'] === null) {
            $invalidProperties[] = "'protection' can't be null";
        }
     ...
     * Sets protection
     *
     * @param string $protection Known values (open set — tolerate new ones): `open`, `protected`, `exclusive`.
     *
     * @return self
     */
