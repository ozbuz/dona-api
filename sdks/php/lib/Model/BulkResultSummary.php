...
/**
 * BulkResultSummary Class Doc Comment
 *
 * @category Class
 * @package  Dona\Api
 * @author   OpenAPI Generator team
 ...
 */
class BulkResultSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BulkResult_summary';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['held'] === null) {
            $invalidProperties[] = "'held' can't be null";
        }
