...
class DeclineRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets reason
     *
     * @param string $reason Uzum subset (`OUT_OF_STOCK`, `OUT_OF_PACKAGE`, `OUT_OF_TIME`, `OTHER`) mapped onto the native `declineReasons`, OR a native lowercase code. `OTHER`/`other` needs `comment`. Unknown ⇒ `400 invalid_decline_reason`. Known values (open set — tolerate new ones): `OUT_OF_STOCK`, `OUT_OF_PACKAGE`, `OUT_OF_TIME`, `OTHER`, `out_of_stock`, `inventory_mismatch`, `product_damaged`, `store_unavailable`, `cannot_fulfill_in_time`, `duplicate_order`, `fraud_suspected`, `other`.
     *
     * @return self
     */
