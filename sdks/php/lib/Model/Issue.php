...
class Issue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['detail'] === null && !$this->isNullableSetToNull('detail')) {
            $invalidProperties[] = "'detail' is required";
        }
     ...
     * Sets source
     *
     * @param string $source Known values (open set — tolerate new ones): `listing_issue`, `violation`, `shop_hold`.
     *
     * @return self
     */
     ...
     * Sets severity
     *
     * @param string $severity Known values (open set — tolerate new ones): `error`, `warning`.
     *
     * @return self
     */
