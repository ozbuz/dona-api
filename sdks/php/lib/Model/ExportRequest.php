...
class ExportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'format' => 'string',
        'filters' => '\Dona\Api\Model\ExportRequestFilters'
    ];
    ...
    {
        $this->setIfExists('format', $data ?? [], 'jsonl');
     ...
     * Sets format
     *
     * @param string|null $format Known values (open set — tolerate new ones): `csv`, `jsonl`.
     *
     * @return self
     */
     ...
     * Gets filters
     *
     * @return \Dona\Api\Model\ExportRequestFilters|null
     */
     ...
     * Sets filters
     *
     * @param \Dona\Api\Model\ExportRequestFilters|null $filters filters
     *
     * @return self
     */
