...
/**
 * AttentionPage Class Doc Comment
 *
 * @category Class
 * @package  Dona\Api
 * @author   OpenAPI Generator team
 ...
 */
class AttentionPage implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AttentionPage';
    ...
    protected static $openAPITypes = [
        'items' => '\Dona\Api\Model\AttentionItem[]',
        'next_cursor' => 'string',
        'has_more' => 'bool',
        'meta' => 'array<string,mixed>',
        'counts' => '\Dona\Api\Model\AttentionCounts'
    ];
     ...
     * Gets items
     *
     * @return \Dona\Api\Model\AttentionItem[]
     */
     ...
     * Sets items
     *
     * @param \Dona\Api\Model\AttentionItem[] $items items
     *
     * @return self
     */
     ...
     * Sets next_cursor
     *
     * @param string|null $next_cursor Pass back as `?cursor=`. `null` when `has_more` is false.
     *
     * @return self
     */
     ...
     * Sets meta
     *
     * @param array<string,mixed>|null $meta Endpoint-specific facts; clients must tolerate unknown keys.
     *
     * @return self
     */
     ...
     * Gets counts
     *
     * @return \Dona\Api\Model\AttentionCounts
     */
     ...
     * Sets counts
     *
     * @param \Dona\Api\Model\AttentionCounts $counts counts
     *
     * @return self
     */
