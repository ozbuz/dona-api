...
/**
 * MetricDetail Class Doc Comment
 *
 * @category Class
 * @package  Dona\Api
 * @author   OpenAPI Generator team
 ...
 */
class MetricDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'MetricDetail';
    ...
    protected static $openAPITypes = [
        ...
        'passing' => 'bool',
        'has_detail' => 'bool',
        'history' => '\Dona\Api\Model\MetricDetailAllOfHistory[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('has_detail', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['current_value'] === null && !$this->isNullableSetToNull('current_value')) {
            $invalidProperties[] = "'current_value' is required";
        }
        ...
        if ($this->container['has_detail'] === null) {
            $invalidProperties[] = "'has_detail' can't be null";
        }
     ...
     * Sets current_value
     *
     * @param mixed|null $current_value null when no data One of: number, string (or null).
     *
     * @return self
     */
     ...
     * Sets applied_to
     *
     * @param string[] $applied_to applied_to
     *
     * @return self
     */
    ...
    {
        return $this->container['has_detail'];
    }

    /**
     * Sets has_detail
     *
     * @param bool $has_detail has_detail
     *
     * @return self
     */
    public function setHasDetail($has_detail)
    {
        if (is_null($has_detail)) {
            throw new \InvalidArgumentException('non-nullable has_detail cannot be null');
        }
        $this->container['has_detail'] = $has_detail;
     ...
     * Gets history
     *
     * @return \Dona\Api\Model\MetricDetailAllOfHistory[]
     */
     ...
     * Sets history
     *
     * @param \Dona\Api\Model\MetricDetailAllOfHistory[] $history history
     *
     * @return self
     */
