 ...
 */
class EventLinks implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Event_links';
     ...
     * Sets self
     *
     * @param string $self Relative URL of the subject.
     *
     * @return self
     */
