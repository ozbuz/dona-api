 ...
 */
class ProductPage implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ProductPage';
     ...
     * Sets items
     *
     * @param \Dona\Api\Model\Product[] $items items
     *
     * @return self
     */
