...
class WebhookCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets url
     *
     * @param string $url `https://` with a CA-signed certificate; private, loopback, link-local and metadata addresses are refused.
     *
     * @return self
     */
    ...
    public function setEventTypes($event_types)
    {
        ...
        if ((count($event_types) < 1)) {
            throw new \InvalidArgumentException('invalid length for $event_types when calling WebhookCreate., number of items must be greater than or equal to 1.');
        }
