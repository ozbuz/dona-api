...
/**
 * HeldForReviewSubject Class Doc Comment
 *
 * @category Class
 * @package  Dona\Api
 * @author   OpenAPI Generator team
 ...
 */
class HeldForReviewSubject implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'HeldForReview_subject';
     ...
     * Sets type
     *
     * @param string $type Known values (open set — tolerate new ones): `product`, `product_variant`, `batch`.
     *
     * @return self
     */
