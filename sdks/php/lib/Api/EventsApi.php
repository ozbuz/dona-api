...
class EventsApi
{
     ...
     *
     * @param  string|null $cursor Last event id seen. (optional)
     * @param  string|null $since ISO 8601 or epoch-ms; ignored when &#x60;cursor&#x60; is set. (optional)
     * @param  string[]|null $types Repeatable; exact names or prefixes (&#x60;order.*&#x60;). (optional)
    ...
    public function listEventsRequest($cursor = null, $since = null, $types = null, $limit = 100, $if_none_match = null, $accept_language = 'uz', $dona_seller = null, $x_dona_integration = null, string $contentType = self::contentTypes['listEvents'][0])
    {
        ...
        if ($limit !== null && $limit > 200) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling EventsApi.listEvents, must be smaller than or equal to 200.');
        }
        ...
        if ($x_dona_integration !== null && strlen($x_dona_integration) > 128) {
            throw new \InvalidArgumentException('invalid length for "$x_dona_integration" when calling EventsApi.listEvents, must be smaller than or equal to 128.');
        }
