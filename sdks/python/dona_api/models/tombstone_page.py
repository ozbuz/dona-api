...
T = TypeVar("T", bound="TombstonePage")
...
class TombstonePage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.tombstone import Tombstone  # noqa: PLC0415

        d = dict(src_dict)
        items = []
        _items = d.pop("items")
        for items_item_data in _items:
            items_item = Tombstone.from_dict(items_item_data)
        ...
        tombstone_page.additional_properties = d
        return tombstone_page
