...
T = TypeVar("T", bound="AccountSuppressedEventData")


@_attrs_define
class AccountSuppressedEventData:
    """
    Attributes:
        suppressed (bool):
        can_sell (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        account_suppressed_event_data = cls(
            suppressed=suppressed,
            can_sell=can_sell,
            action_url=action_url,
        ...
        account_suppressed_event_data.additional_properties = d
        return account_suppressed_event_data
