...
class EventPage:
    ...
    Attributes:
        items (list[Event]):
        next_cursor (None | str): The id of the LAST event returned (or your own cursor echoed when `items` is empty).
            Store it after your batch commits; never null once you have seen an event.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        event_page.additional_properties = d
        return event_page
