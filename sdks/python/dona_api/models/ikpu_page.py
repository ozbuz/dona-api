...
if TYPE_CHECKING:
    from ..models.ikpu import Ikpu
    from ..models.page_meta import PageMeta


T = TypeVar("T", bound="IkpuPage")
...
class IkpuPage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.ikpu import Ikpu  # noqa: PLC0415
        ...
        for items_item_data in _items:
            items_item = Ikpu.from_dict(items_item_data)
        ...
        ikpu_page.additional_properties = d
        return ikpu_page
