...
T = TypeVar("T", bound="ExportRequestFilters")
...
class ExportRequestFilters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        updated_since = d.pop("updated_since", UNSET)
        ...
        export_request_filters.additional_properties = d
        return export_request_filters
