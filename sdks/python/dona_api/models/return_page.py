...
class ReturnPage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.return_ import Return  # noqa: PLC0415

        d = dict(src_dict)
        items = []
        _items = d.pop("items")
        for items_item_data in _items:
            items_item = Return.from_dict(items_item_data)
        ...
        return_page.additional_properties = d
        return return_page
