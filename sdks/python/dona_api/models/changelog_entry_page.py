...
T = TypeVar("T", bound="ChangelogEntryPage")
...
class ChangelogEntryPage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.changelog_entry import ChangelogEntry  # noqa: PLC0415
        ...
        for items_item_data in _items:
            items_item = ChangelogEntry.from_dict(items_item_data)
        ...
        changelog_entry_page.additional_properties = d
        return changelog_entry_page
