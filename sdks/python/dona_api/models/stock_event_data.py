...
T = TypeVar("T", bound="StockEventData")


@_attrs_define
class StockEventData:
    """
    Attributes:
        product_id (UUID):
        stock (int):
        variant_id (None | Unset | UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        stock_event_data.additional_properties = d
        return stock_event_data
