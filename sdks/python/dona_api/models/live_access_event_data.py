...
T = TypeVar("T", bound="LiveAccessEventData")


@_attrs_define
class LiveAccessEventData:
    """
    Attributes:
        state (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        live_access_event_data = cls(
            state=state,
            until=until,
        )

        live_access_event_data.additional_properties = d
        return live_access_event_data
