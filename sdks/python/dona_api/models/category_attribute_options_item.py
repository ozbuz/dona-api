...
T = TypeVar("T", bound="CategoryAttributeOptionsItem")


@_attrs_define
class CategoryAttributeOptionsItem:
    """
    Attributes:
        code (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        category_attribute_options_item = cls(
            code=code,
            label=label,
        )

        category_attribute_options_item.additional_properties = d
        return category_attribute_options_item
