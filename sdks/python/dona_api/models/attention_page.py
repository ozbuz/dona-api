...
class AttentionPage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.attention_counts import AttentionCounts  # noqa: PLC0415
        from ..models.attention_item import AttentionItem  # noqa: PLC0415
        ...
        counts = AttentionCounts.from_dict(d.pop("counts"))
        ...
        attention_page.additional_properties = d
