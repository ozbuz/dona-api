...
T = TypeVar("T", bound="AccountDocumentsEventData")


@_attrs_define
class AccountDocumentsEventData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        account_documents_event_data = cls(
            documents_status=documents_status,
            can_sell=can_sell,
            action_url=action_url,
        ...
        account_documents_event_data.additional_properties = d
        return account_documents_event_data
