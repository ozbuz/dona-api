...
T = TypeVar("T", bound="AccountKycEventData")


@_attrs_define
class AccountKycEventData:
    """
    Attributes:
        kyc_status (str):
        can_sell (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        account_kyc_event_data.additional_properties = d
        return account_kyc_event_data
