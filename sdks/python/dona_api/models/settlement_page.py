...
T = TypeVar("T", bound="SettlementPage")
...
class SettlementPage:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.settlement import Settlement  # noqa: PLC0415

        d = dict(src_dict)
        items = []
        _items = d.pop("items")
        for items_item_data in _items:
            items_item = Settlement.from_dict(items_item_data)
        ...
        settlement_page.additional_properties = d
