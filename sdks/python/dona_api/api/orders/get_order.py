...
from ...models.order_with_pii import OrderWithPii
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        def _parse_response_200(data: object) -> Order | OrderWithPii:
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                response_200_type_0 = Order.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            response_200_type_1 = OrderWithPii.from_dict(data)
