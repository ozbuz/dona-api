...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Error | OrderTimeline | None:
    if response.status_code == 200:
        response_200 = OrderTimeline.from_dict(response.json())
