...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> BrandPage | Error | None:
    if response.status_code == 200:
        response_200 = BrandPage.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[BrandPage | Error]:
    return Response(
