...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Error | Verification | None:
    if response.status_code == 200:
        response_200 = Verification.from_dict(response.json())
