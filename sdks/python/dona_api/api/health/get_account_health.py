...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Error | HealthSummary | None:
    if response.status_code == 200:
        response_200 = HealthSummary.from_dict(response.json())
