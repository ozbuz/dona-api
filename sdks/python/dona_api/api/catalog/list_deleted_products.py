...
from ...models.tombstone_page import TombstonePage
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Error | TombstonePage | None:
    if response.status_code == 200:
        response_200 = TombstonePage.from_dict(response.json())
