# dona-api
A client library for accessing Dona API

## Usage
First, create a client:

```python
from dona_api import Client
...
```python
from dona_api.models import MyDataModel
from dona_api.api.my_tag import get_my_data_model
from dona_api.types import Response
...
1. Any endpoint which did not have a tag will be in `dona_api.api.default`
