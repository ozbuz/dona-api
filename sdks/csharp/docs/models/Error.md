...
**DocUrl** | **string** | Anchor into the docs for this code: &#x60;https://dona.uz/&lt;lang&gt;/developers/errors#&lt;code&gt;&#x60; — &#x60;&lt;lang&gt;&#x60; is the key owner&#39;s language (uz | ru | en) when a key authenticated the request, else &#x60;Accept-Language&#x60;, else &#x60;uz&#x60;. The docs site is per language; there is no language-less &#x60;/developers&#x60; page. | 
