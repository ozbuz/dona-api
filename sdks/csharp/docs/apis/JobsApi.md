...
<a id="exportorders"></a>
# **ExportOrders**
> JobAccepted ExportOrders (string idempotencyKey, ExportRequest exportRequest, string acceptLanguage = null, string xDonaIntegration = null)
...
|-------------|-------------|------------------|
| **202** | Accepted |  * Dona-Request-Id -  <br>  * RateLimit-Policy -  <br>  * RateLimit -  <br>  * X-RateLimit-Limit -  <br>  * X-RateLimit-Remaining -  <br>  * X-RateLimit-Reset -  <br>  * X-Dona-Key-Expires -  <br>  * Dona-API-Warn -  <br>  * Deprecation -  <br>  * Sunset -  <br>  * Cache-Control -  <br>  |
...
# **ExportProducts**
> JobAccepted ExportProducts (string idempotencyKey, ExportRequest exportRequest, string acceptLanguage = null, string xDonaIntegration = null)
...
<a id="getjob"></a>
# **GetJob**
> Job GetJob (Guid id, string acceptLanguage = null, string xDonaIntegration = null)
