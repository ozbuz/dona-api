...
# **GetAccountHealth**
> HealthSummary GetAccountHealth (string acceptLanguage = null, string xDonaIntegration = null)
...
# **GetAccountMetric**
> MetricDetail GetAccountMetric (string metricId, string acceptLanguage = null, string xDonaIntegration = null)
...
> Verification GetAccountVerification (string acceptLanguage = null, string xDonaIntegration = null)
