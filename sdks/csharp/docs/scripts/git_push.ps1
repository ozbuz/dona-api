param(
    ...
    [Parameter()][Alias("u")][String]$GitUserId = "ozbuz",
    [Parameter()][Alias("r")][String]$GitRepoId = "dona-api",
    [Parameter()][Alias("m")][string]$Message = "Generated from spec/openapi.yaml - see https://github.com/ozbuz/dona-api",
