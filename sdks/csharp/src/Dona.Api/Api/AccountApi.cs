...
namespace Dona.Api.Api
{
    ...
    public interface IAccountApi : IApi
    {
        ...
        Task<IGetMeApiResponse> GetMeAsync(Option<string> acceptLanguage = default, Option<Guid> donaSeller = default, Option<string> xDonaIntegration = default, System.Threading.CancellationToken cancellationToken = default);
    ...
    public sealed partial class AccountApi : IAccountApi
    {
        ...
        /// <param name="xDonaIntegration"></param>
        private void AfterGetMeDefaultImplementation(IGetMeApiResponse apiResponseLocalVar, Option<string> acceptLanguage, Option<Guid> donaSeller, Option<string> xDonaIntegration)
        {
            bool suppressDefaultLog = false;
            AfterGetMe(ref suppressDefaultLog, apiResponseLocalVar, acceptLanguage, donaSeller, xDonaIntegration);
        ...
        /// <param name="donaSeller"></param>
        /// <param name="xDonaIntegration"></param>
        partial void AfterGetMe(ref bool suppressDefaultLog, IGetMeApiResponse apiResponseLocalVar, Option<string> acceptLanguage, Option<Guid> donaSeller, Option<string> xDonaIntegration);
        ...
        /// <param name="donaSeller"></param>
        /// <param name="xDonaIntegration"></param>
        private void OnErrorGetMeDefaultImplementation(Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<string> acceptLanguage, Option<Guid> donaSeller, Option<string> xDonaIntegration)
        {
            bool suppressDefaultLogLocalVar = false;
            OnErrorGetMe(ref suppressDefaultLogLocalVar, exceptionLocalVar, pathFormatLocalVar, pathLocalVar, acceptLanguage, donaSeller, xDonaIntegration);
        ...
        /// <param name="donaSeller"></param>
        /// <param name="xDonaIntegration"></param>
        partial void OnErrorGetMe(ref bool suppressDefaultLogLocalVar, Exception exceptionLocalVar, string pathFormatLocalVar, string pathLocalVar, Option<string> acceptLanguage, Option<Guid> donaSeller, Option<string> xDonaIntegration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetMeApiResponse"/>&gt;</returns>
        public async Task<IGetMeApiResponse?> GetMeOrDefaultAsync(Option<string> acceptLanguage = default, Option<Guid> donaSeller = default, Option<string> xDonaIntegration = default, System.Threading.CancellationToken cancellationToken = default)
        {
            try
            {
                return await GetMeAsync(acceptLanguage, donaSeller, xDonaIntegration, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception)
            {
                return null;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns><see cref="Task"/>&lt;<see cref="IGetMeApiResponse"/>&gt;</returns>
        public async Task<IGetMeApiResponse> GetMeAsync(Option<string> acceptLanguage = default, Option<Guid> donaSeller = default, Option<string> xDonaIntegration = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                FormatGetMe(ref acceptLanguage, ref donaSeller, ref xDonaIntegration);
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ...
                        AfterGetMeDefaultImplementation(apiResponseLocalVar, acceptLanguage, donaSeller, xDonaIntegration);
            ...
            {
                OnErrorGetMeDefaultImplementation(e, "/me", uriBuilderLocalVar.Path, acceptLanguage, donaSeller, xDonaIntegration);
