...
openapi_generator php "$spec" "$out" \
  "invokerPackage=Dona\\Api,packageName=dona-api,artifactVersion=${version},licenseName=Apache-2.0,developerOrganization=Dona,developerOrganizationUrl=https://dona.uz,artifactUrl=https://github.com/ozbuz/dona-api"
